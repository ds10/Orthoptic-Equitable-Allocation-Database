...
class Preference(db.Model):
    ...
    sugguestedallocation = db.Column(db.Integer)
    agreedallocation = db.Column(db.Integer)
    year = db.Column(db.Integer)
    institutions = db.relationship(Institution, backref='topic')

    def __init__(self, name, institutionid, universities, years, capacity, wte, sugguestedallocation, agreedallocation, year):
        self.name = name
        ...
        self.wte = wte
        self.sugguestedallocation = sugguestedallocation
